...
year of local tax payments go? It is modeled on the National Priorities
...
local taxpayers is removed — rather than gross spending. Second, it is
addressed to a **household**, owner or renter alike, not only to a property-tax
payer.
...
- **U.S. Census Bureau, 2020–2024 American Community Survey 5-year estimate** —
  the household count.

All financial figures are audited or reconciled FY2025 actuals. No estimates
or projections are used.

## The household figures
...
Bedford's FY2025 tax classification hearing. At that value the property tax
bill is **$4,448.48**.

The receipt adds a motor vehicle excise line. Citywide motor vehicle and other
excise was **$9,837,910** (ACFR, p. 24). Divided by **42,271** households
(Census, 2020–2024 ACS), that is about **$233** per household. The line is
presented as a citywide average, not a household-specific figure: the
numerator includes business-registered vehicles and boat excise, and the
denominator is households rather than registered vehicles.

For the average single-family home, the receipt's headline — property tax plus
excise — is about **$4,681**.
...
The receipt anchors this on residential property tax. For every $1 of
residential property tax, the city took in **$6.60** in total revenue — the
other $5.60 from commercial property, fees, state aid, and federal grants. The
point is the scale of outside funding: local residential tax is a small part
of what pays for city government.
...
## Section 2 — What your local tax dollars funded
...
is the base across which a household's local taxes are distributed.
...
Each household's local taxes — property tax plus excise — are distributed
across the eight positive functions in proportion to net local cost. For the
average single-family home, the roughly $4,681 total resolves into about
$1,289 for public safety, $1,144 for education, and the balance across the
other functions.
...
### The motor vehicle excise denominator

The excise line divides citywide motor vehicle and other excise by the number
of households. Households, not residential parcels, is the denominator: New
Bedford's large stock of two- and three-family houses means one taxable parcel
often holds several households, so a parcel count would understate the
denominator and overstate the per-household figure. The numerator is citywide
and includes business-registered vehicles and boat excise, so the line is a
rough citywide average per household, not a precise per-auto amount.
...
- The excise line is a citywide average, not a household-specific figure.
