...
or installation is needed — everything runs locally in the page. Type a single-family home's assessed value into the input field; the default is the FY2025
